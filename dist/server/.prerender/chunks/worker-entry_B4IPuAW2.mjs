...
function deserializeActionResult(res) {
  if (res.type === "error") {
    ...
    if (Object.assign(__vite_import_meta_env__$1, { _: "/Users/cjbhatnagar/Documents/Portfolio/node_modules/.bin/astro" })?.PROD) {
...
function serializeActionResult(res) {
  if (res.error) {
    if (Object.assign(__vite_import_meta_env__, { _: "/Users/cjbhatnagar/Documents/Portfolio/node_modules/.bin/astro" })?.DEV) {
